...
select doctors.name, sum(round((attendances.hours * 150) + (((work_shifts.bonus) / 100) * (attendances.hours * 150)), 1))
as salary from doctors inner join attendances on doctors.id = attendances.id_doctor
